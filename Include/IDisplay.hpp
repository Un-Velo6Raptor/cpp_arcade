...
namespace ar {
	...
	public:
		 ...
		 */
		virtual void loadSprites(const std::string &filePath, const std::map<unsigned char, spriteCoords> &sprites
		) = 0;
		 ...
		 */
		virtual void initMenu(const std::vector<std::string> &menuChoices, const std::string &menuName) = 0;
